...
<section class="cases tabs">
	<div class="wrapper">
		<h2 class="cases__title secondary-title"><span><?php echo esc_attr($title1); ?></span><br><?php echo esc_attr($title2); ?></h2>
		<div class="tabs__wrap">

			<p class="tabs__descr"><?php echo esc_attr($content); ?></p>
			<!-- Cases titles -->
