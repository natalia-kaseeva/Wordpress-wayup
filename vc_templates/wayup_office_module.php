...
<section class="offices">
	<div class="wrapper">
		<h2 class="offices__title secondary-title"><span><?php echo esc_attr($title1); ?></span><br><?php echo esc_attr($title2); ?></h2>
		<div class="map">
