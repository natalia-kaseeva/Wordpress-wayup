...
class Wayup_Rating_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' =>esc_html__('A widget that displays a rating block', 'wayup') 
		);
		...
		/* Create the widget. */
		parent::__construct( 'wayup_rating_widget', esc_html__('Wayup | Rating'), $widget_ops, $control_ops );
	}
	...
	public function form( $instance ) 
	{
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id( 'title' ); ?>">Rating | Title</label>
