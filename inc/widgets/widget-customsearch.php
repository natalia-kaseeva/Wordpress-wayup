...
class Wayup_Customsearch_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' =>esc_html__('A widget that displays special procedure of search', 'wayup') 
		);
		...
		/* Create the widget. */
		parent::__construct( 'wayup_customsearch_widget', esc_html__('Wayup | Special Search'), $widget_ops, $control_ops );
	}
	/**
	 * Display Widget
	 * @param array $args
