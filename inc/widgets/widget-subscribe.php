...
class Wayup_Subscribe_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' =>esc_html__('A widget that displays a subscription part', 'wayup') 
		);
		...
		/* Create the widget. */
		parent::__construct( 'wayup_subscribe_widget', esc_html__('Wayup | Subscription'), $widget_ops, $control_ops );
	}
	/**
	 * Display Widget
	 * @param array $args
