...
class Wayup_Category_Widget extends WP_Widget 
{
	...
	public function __construct() {
		...
		$widget_ops = array(
			...
			'description' =>esc_html__('A widget that displays a news category part', 'wayup') 
		);
		...
		/* Create the widget. */
		parent::__construct( 'wayup_category_widget', esc_html__('Wayup | Category'), $widget_ops, $control_ops );
	}
	/**
	 * Display Widget
	 * @param array $args
