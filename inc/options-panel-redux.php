<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'desc'     => esc_html__( 'Let the field empty if you do not have a link', 'wayup' ),
                'label'    => true,
                'options'  => array(
                    'Vkontakte Link'   => '',
                    'Facebook Link'   => '',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'      => 'footer_section1',
                'type'    => 'text',
                'title'   => esc_html__( 'Fist Section Title', 'wayup' ),
                'default'  => 'Карта сайта',
            ),
            array(
                'id'      => 'footer_section2',
            ...
            array(
                'id'      => 'footer_section4',
                'type'    => 'text',
                'title'   => esc_html__( 'Fouth Section Title', 'wayup' ),
                'default'  => 'Контакты',
            ),
            array(
                'id'     => 'footerwidget-end',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                ...
                'text_hint' => array(
                    'title'   => 'YouTube link',
                    'content' => 'Use the browser link for YouTube video'
                )
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
     ...
     Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'      => 'testylabel1',
                'type'    => 'text',
                'title'   => esc_html__( 'Specify the Label1', 'wayup' ),
                'default'  => 'За нас говорят',
            ),
            array(
                'id'      => 'testylabel2',
                'type'    => 'text',
                'title'   => esc_html__( 'Specify the Label2', 'wayup' ),
     ...
     Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            ...
            array(
                'id'      => 'caseslabel',
                'type'    => 'text',
                'title'   => esc_html__( 'Title for slider of cases ', 'wayup' ),
                'default'  => 'Посмотрите наши последние кейсы',
            ),
            array(
                'id'      => 'servicearchivetitle1',
                'type'    => 'text',
                'title'   => esc_html__( 'Title 1 of Archive Page', 'wayup' ),
                'default'  => 'Наши',
            ),
            array(
                'id'      => 'servicearchivetitle2',
                'type'    => 'text',
                'title'   => esc_html__( 'Title 2 of Archive Page', 'wayup' ),
                'default'  => 'УСЛУГИ',
            ),
            array(
                'id'      => 'servicearchivedesc',
                'type'    => 'text',
                'title'   => esc_html__( 'Description or Archive Page', 'wayup' ),
     ...
     Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'News', 'wayup' ),//'Новости'
        'id'               => 'newssposttype',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Data for News Page', 'wayup' ),
        'fields'           => array(
            array(
                'id'      => 'newstitle1',
                'type'    => 'text',
                'title'   => esc_html__( 'Title (part 1)', 'wayup' ),
                'default'  => 'Актуальные',
            ),
            array(
                'id'      => 'newstitle2',
                'type'    => 'text',
                'title'   => esc_html__( 'Title (part 2)', 'wayup' ),
                'default'  => 'НОВОСТИ',
            ),
            array(
                'id'      => 'newspostperpage',
                'type'    => 'text',
                'title'   => esc_html__( 'Specify the count of news per page', 'wayup' ),
                'default'  => '4',
            ),
            array(
                'id'      => 'newscategorytitle',
                'type'    => 'text',
                'title'   => esc_html__( 'Title for news category', 'wayup' ),
                'default'  => 'Категория',
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Shop', 'wayup' ),//'Новости'
        'id'               => 'woosettings',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Data for Shop Page', 'wayup' ),
        'fields'           => array(
            array(
                'id'      => 'wootitle1',
                'type'    => 'text',
            ...
            array(
                'id'      => 'woolink',
                'type'    => 'text',
                'title'   => esc_html__( 'Collection link', 'wayup' ),
                'default'  => '#',
            ),
            array(
                'id'       => 'woo_bg',
                'type'     => 'media',
                'url'      => true,
                'title'    => esc_html__('Background for Shop Header', 'wayup' ),
                'compiler' => 'true',
                'desc'     => esc_html__( 'Download image', 'wayup' ),
