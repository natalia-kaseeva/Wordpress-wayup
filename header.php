...
<!-- Проверка для шапки главной страницы и остальных страниц сайта -->
<?php 
...
?>
<!-- End Проверка для шапки главной страницы и остальных страниц сайта-->

<?php /*$test=get_option('themename_theme_options'); echo $test['text_test']; echo'<br>'; echo $test['color_scheme']; echo'<br>'; echo $test['image_upload_test'];*/ ?>
				...
				<div class="offer__slider">
					...
					foreach($slider as $slide) { ?>
						...
						<div class="offer__slide">
							...
							<a href="<?php echo $slide['lurl']; ?>" class="offer__btn btn popup-link"><?php esc_html_e('Бесплатная консультация','wayup') ?></a>
						</div>
					<?php } ?>
