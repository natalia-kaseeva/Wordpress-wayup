					...
					<div class="promo">
							...
							<div class="coupon">
								<?php if ( wc_coupons_enabled() ) { ?>
									<input type="text" name="coupon_code" class="input-text promo__input log__input" id="coupon_code" value="" placeholder="Код купона" /> <button type="submit" class="button  btn_woo promo__btn" name="apply_coupon" value="Применить купон">Применить купон</button>
									<?php do_action( 'woocommerce_cart_coupon' ); ?>
								<?php } ?>

									<button type="submit" class="button btn_woo promo__btn" name="update_cart" value="Обновить корзину">Обновить корзину</button>
