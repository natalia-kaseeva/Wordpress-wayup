	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
		...
		<p class="log__title">Оставьте ваш отзыв</p>
				...
				$comment_form = array(
					...
					'comment_notes_after' => '',
					'fields'              => array(
						'author' => '<div class="log__group"><label for="author">' . esc_html__( 'Name', 'woocommerce' ) . '&nbsp;</label> ' .
						...
						'email'  => '<div class="log__group"><label for="email">' . esc_html__( 'Email', 'woocommerce' ) . '&nbsp;</label> ' .
									'<input id="email" class="log__input" name="email" type="text" value="' . esc_attr( $commenter['comment_author_email'] ) . '" size="30" required /></div>',
						...
						'social'  => '<div class="log__group log__group_socials"><label for="social">' . esc_html__( 'Social link', 'wayup' ) . '&nbsp;</label> ' .
									'<input id="social" class="log__input" name="social" type="text" value="" size="30" /></div>',
					),
					'label_submit'        => __( 'Submit', 'woocommerce' ),
					'logged_in_as'        => '<div class="log__group"><label for="phone">' . esc_html__( 'Phone', 'wayup' ) . '&nbsp;</label> ' .'<input id="phone" class="log__input" name="phone" type="text" value="" size="30" aria-required="true" required /></div>
									<div class="log__group log__group_socials"><label for="social">' . esc_html__( 'Social link', 'wayup' ) . '&nbsp;</label> ' .'<input id="social" class="log__input" name="social" type="text" value="" size="30" /></div>',
					'comment_field'       => '',
				);
				...
				$comment_form['comment_field'] = '<div class="log__group log__group_textarea"><label for="comment">' . esc_html__( 'Your review', 'wayup' ) . '&nbsp;</label><textarea id="comment" name="comment" cols="45" class="log__input" rows="8" required></textarea></div><p class="log__line"><span>*</span>Поля обязательные для заполнения</p>';
