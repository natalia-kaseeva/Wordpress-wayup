...
<div <?php comment_class('clients__box'); ?> id="li-comment-<?php comment_ID() ?>">
	...
	<div class="clients__say">
		<p class="clients__name"><?php comment_author(); ?> <?php if(current_user_can('manage_options') && get_comment_meta(get_comment_ID(),'phone',true)) { echo '(' .get_comment_meta(get_comment_ID(),'phone',true).')'; } ?></p>
